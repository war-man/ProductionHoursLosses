...
namespace ProductionHoursLosses.Controllers
{
    public class HeaderController : Controller
    {
        ...
        public JsonResult Export2Excel()
        {
                ...
                foreach (var hdr in HeaderList)
                {
                    ...
                    if (hdr.DETAIL != null && hdr.DETAIL.Count > 0)
                    {
                        foreach (var det in hdr.DETAIL.ToList())
                        {
                            ...
                            row[7] = (det.START_TIME != null ? det.START_TIME.ToString("HH:mm") : "00:00");
                            row[8] = (det.END_TIME != null ? det.END_TIME.ToString("HH:mm") : "00:00");
            ...
            //HeaderListViewModel model = new HeaderListViewModel();
            //return RedirectToAction("Report", "Header", new { model = model });
        }
